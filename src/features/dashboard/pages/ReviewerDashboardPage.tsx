...
export function ReviewerDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <div className="flex size-11 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-brand-accent-2/15 to-primary/10 text-brand-accent-2 shadow-soft-xs">
